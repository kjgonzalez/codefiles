...
\date{\today} % can also be "October 25, 2017" or "2018-10-25" if desired, only treated as string
\maketitle
\pagenumbering{gobble} % turns off page numbering when you don't want it



\includegraphics[width=1\textwidth]{media/titleimg.jpg} % note, you need width=0.5 if dealing w/ two columns
