...
% xx need to give slightly darker background in order for code to properly appear as a block
% xx need to list actual code source in case someone in rwu wants to read it
\begin{lstlisting}
import numpy as np
...
\begin{figure}[H]
    ...
    \caption{xx} % xx be sure to describe the edge of the FOV shown in (e)
