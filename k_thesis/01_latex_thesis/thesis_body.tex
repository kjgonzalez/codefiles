...
\subsubsection{3D Reconstruction with Stereo Data}
...
(explain how pyramid stereo network works) \\
(explain how reconstruction works)
...
The 3D object detection network can be broken up into three main sections, as shown below in Figure \ref{spcl_arch}.
