...
\begin{figure}[H]
    ...
    \subfigure[000015 stereo estimation with new PSMnet* model]{
        \includegraphics[width=1\linewidth]{../media/ind15_psmnetstar_v190613_AsOf190626.png}}
...
\begin{figure}[H]
    \centering
    \subfigure[Loss vs Epochs during Training]{
        \includegraphics[width=0.3\linewidth]{../media/info_Loss_190613_psmstar.pdf}}
    \subfigure[Validation Error vs Epochs during Training]{
        \includegraphics[width=0.3\linewidth]{../media/info_ValError_190613_psmstar.pdf}}
