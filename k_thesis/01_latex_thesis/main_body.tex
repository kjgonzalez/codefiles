...
In order to transition from using the provided pretrained model and preprocessed data to self-made preprocessed and trained data, a set of steps and "paths" were created to clarify what was happening in each step and set of "runs". As shown below in Figure \ref{fppaths}, there are various 

\begin{figure}[ht] % h = "approx here", {h,t,b}
    \label{fppaths}
    \includegraphics[width=1\textwidth]{\m/fpnet_paths_img.png}
