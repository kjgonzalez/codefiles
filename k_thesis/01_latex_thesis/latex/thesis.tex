...
\usepackage{float} % note: moving float before hyperref doesn't help
...
\fancyhf{}
\setlength{\headheight}{13.6pt} % gets rid of headheight error
...
\definecolor{bggray}{rgb}{0.92,0.92,0.92}
\lstset{frame=tb,
    language=Python,
...
% BIBLIOGRAPHY =================================================================
\newpage
%\nocite{*} % list all references for now. % 190819: no longer will cite all at once
