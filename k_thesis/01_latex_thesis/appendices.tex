...
1    score        Only for results: Float, indicating confidence in
	...
	\end{lstlisting}
	\onehalfspacing % set line spacing back to normal
	\caption{Original text from readme.txt file of devkit\_object resources.}
...
%\begin{table}[h]
%	\centering
%	\caption{KITTI dataset class count. NEEDS TO BE FIXED XX}
%	\begin{tabular}{|c|c|}%
%		\hline
%		\bfseries Class & \bfseries Count % specify table head
%		\csvreader[head to column names]{../media/TEMP_kitti_class_stats_xx.csv}{}% use head of csv as column names
