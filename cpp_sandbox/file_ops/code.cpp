...
std::vector<std::string> getConfig(const char* filename){
...
int main(){
	// std::string fname = "readme.csv";
	std::vector<std::string> configvalues=getConfig("config.txt");
	std::cout << "substring values: \n";
	for(int i=0;i<configvalues.size();i++) std::cout << configvalues[i]<<"\n";
