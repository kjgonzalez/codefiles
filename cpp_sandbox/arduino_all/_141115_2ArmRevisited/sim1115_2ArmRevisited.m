...
% configuration: "elbow up" / right arm
...
x1=r1*cos(a1);
y1=r1*sin(a1);
x2=x1+r2*cos(a1-a2); %CHANGE HERE FOR ELBOW CONFIG (-=up)
y2=y1+r2*sin(a1-a2); %CHANGE HERE FOR ELBOW CONFIG (-=up)

kjga1=round(a1*180/pi)
kjga2=round(a2*180/pi)


%plot everything
clf;
hold on;
plotline(r2*[-1 -1],(r1+r2)*[1.1 1.1],'k.');
plot(xd,yd,'rx');
plot(0,0,'ko');
